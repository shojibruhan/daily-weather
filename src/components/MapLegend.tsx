...
const MapLegend = ({ mapType }: Props) => {
  ...
  const gradientStops = data.stops
    ...
    .join(",");
  return (
    <div className="absolute top-4 right-4 z-1000 w-48 xs:w-96 flex flex-col gap-0.5 xs:gap-4 bg-background/50 border-accent/70 rounded-xl shadow-lg p-2 xs:p-4">
